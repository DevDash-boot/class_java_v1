...
public class Exercise4 {
    public static void main(String[] args) {
        ...
        // 2. result1 변수를 정수형으로 강제 형변환 해서 출력하세요
        System.out.println("정수 result1 : " + (int) result1);
        ...
        System.out.println("doubleData가 intData보다 큰가요? " + result2);

        // 6. 변수 result3 을 선언하고 num1과 num2 변수가 합이
        // 숫자 50보다 큰지 비교연산자(or 삼항연산자)를 사용해서 결과를 담고 출력하세요.
        int num1 = 10;
        int num2 = 30;
        boolean result3 = (num1 + num2) > 50; // 비교 연산자
        // boolean result3= ((num1 + num2)>50) ? true : false;  삼항 연산자
        System.out.println("num1 + num2 > 50 인가요? " + result3);

        // 7. num1과 num2 값 중 큰 수를 삼항 연산자를 사용해서
        // max 변수에 값을 담고 출력해주세요
        int max = (num1 > num2) ? num1 : num2;
        System.out.println("num1(10)과 num2(30) 중 큰 값 : " + max);
